...
<img src="/images/posts/AG/freeformCurve.png" height="180" width="400">  
...
- 局限：1. A Bézier curve with a large number of control points becomes impractical for design. The degree of the curve increases and the curve shape resembles less the shape of the control polygon. \\
...
<img src="/images/posts/AG/NURBS.png" height="180" width="340">  

<img src="/images/posts/AG/BBN.png" height="130" width="340">  

<img src="/images/posts/AG/BN.png" height="170" width="400">  

<img src="/images/posts/AG/CN.png" height="180" width="520">  

<img src="/images/posts/AG/CN2.png" height="301" width="748">
...
- The four-point scheme of Dubuc. Formally, the new point is computed as $p_i^{new} = –1/16 p_{i-1} + 9/16 p_i + 9/16 p_{i+1} – 1/16 p_{i+2}.$

<img src="/images/posts/AG/Dubuc.png" height="244" width="783">  

- One year later, Dyn et al. (1987) generalized the four-point scheme as follows. $p_i^{new} = –w∙p_{i-1} + (1/2 + w)∙p_i + (1/2 + w)∙p_{i+1} – w∙p_{i+2}.$ For w = 1/16 we have the original four-point scheme.
